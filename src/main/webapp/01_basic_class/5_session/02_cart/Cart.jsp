...
<%
	...
	String name = "";
	int price= 0;
	//ArrayList<Goods>의 새로운 변수를 null로 선언
	...
	if (obj == null) {
		glist = new ArrayList<Goods>();	//없는 경우
	} else {
		glist = (ArrayList<Goods>)obj;	//있는 경우에는 기존에 있는 주소값을 받아와서 자료형에 맞게 형 변환
	}

	// 4. ★1번의 값들을 Goods 객체로 생성후★(잊지말기) ArrayList 에 추가
